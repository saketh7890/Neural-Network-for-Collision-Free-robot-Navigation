...
class SimulationEnvironment:
    def __init__(self):
        ...
        # ✅ UNCOMMENT THESE LINES so goal_body exists
    ...
    def _draw_everything(self, velocity=False, steering=True):
        ...
        img_pos, img_ori = self.robot.body.position, degrees(self.robot.body.angle)
        self._apply_image_to_robot(img_pos, img_ori)

        pm_botPos = self.robot.body.position
        if velocity:
        ...
        if steering:
            steering_vector = pm_botPos + self.steering_force*7.5
